const HomeMiddle = () => {
  return (
    <div className="font-[lausanne-500] md:-mt-[4vw]">
      <div className="min-w-[280px] w-[70%] sm:w-[50%] md:w-[35%] ml-auto">
        <p className="text-[13px] md:text-[15px] xl:text-[16px] indent-[10vw] md:indent-[5vw]">
